...
var Button = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(StyledButton, { disabled: disabled ? true : false, onClick: onClick, "$textwhite": textWhite.toString(), "$variant": variant, children: children || label }));
};
